...
import Error from "./inventory-error";
...
export default function Offline({invenData,addInv}) {
  ...
  return (
    ...
    <div className="">
                  ...
                  <div className="row d-flex my-3 p-3 px-5" style={{backgroundColor:'#E3F2FF',overflow:'scroll',flexWrap:"initial"}}>
