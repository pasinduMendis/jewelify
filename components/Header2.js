        ...
        <div className="header-2 pricing-page">
            <div data-animation="default" data-collapse="small" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="navbar-3 w-nav">
                <div className="container-4 w-container">
                    <div onClick={()=>router.push('/')}><div aria-current="page" className="w-nav-brand w--current"><img src="images/Jewelify.png" loading="lazy" alt="" className="image-73" /></div></div>
                    <nav role="navigation" className="nav-menu-3 w-nav-menu">
                        <button className='bg-white' onClick={()=>router.push('/')}><a aria-current="page" className="nav-link-2 w-nav-link w--current">Home</a></button>
                        <div data-hover="false" data-delay={0} data-w-id="26df0f8c-dfbe-a547-f6b3-58b64381191a" className="dropdown-2 w-dropdown">
                            ...
                            <nav className="dropdown-list-2 w-dropdown-list">
                                <button className='bg-white' href="solutions.html"><a className="dropdown-link w-dropdown-link">API Connection</a></button>
                                <button className='bg-white' href="new-landing-page.html"><a className="dropdown-link w-dropdown-link">Website Development</a></button>
                            </nav>
                        </div>
                        <button className='bg-white' onClick={()=>router.push('/pricing')}><a className="nav-link-2 w-nav-link">Pricing</a></button>
                        <button className='bg-white' href="about-us.html"><a className="nav-link-2 w-nav-link">About Us</a></button>
                        <button className='bg-white' href="blog.html"><a className="nav-link-2 w-nav-link">Blog</a></button >
                    </nav >
